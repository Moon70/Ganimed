...
public class MenubarController implements ActionListener{
	...
	private static final String ACTIONCOMMAND_SAVEGIF = "savegif";
	...
	protected MenuItem menuItem_SaveGif;
	...
	private Menu createFileMenu(){
		...
		menuItem_SaveGif=new MenuItem("Save GIF");
		menuItem_SaveGif.setActionCommand(ACTIONCOMMAND_SAVEGIF);
		menuItem_SaveGif.setEnabled(false);
		menu.add(menuItem_SaveGif);
	...
	public void actionPerformed(ActionEvent event){
		...
		}else if(actionCommand.equals(ACTIONCOMMAND_SAVEGIF)){
			view.saveGif();
